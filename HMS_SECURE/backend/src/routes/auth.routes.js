...
async function audit(userId, action, module_name = 'auth', hospital_id = DEFAULT_HOSPITAL_ID) { try { await AuditLog.create({ hospital_id: Number(hospital_id || DEFAULT_HOSPITAL_ID), user_id: userId || null, action, module_name }); } catch (_) { } }
